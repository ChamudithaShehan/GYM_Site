  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 sm:mb-8 px-2 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center animate-fade-in px-2">
          <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white px-6 sm:px-8 py-3 text-base sm:text-lg font-semibold transition-all duration-200 hover:scale-105 w-full sm:w-auto">
            START YOUR JOURNEY
          </Button>
          <Button size="lg" variant="outline" className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-black px-6 sm:px-8 py-3 text-base sm:text-lg font-semibold transition-all duration-200 hover:scale-105 shadow-lg backdrop-blur-sm w-full sm:w-auto">
            LEARN MORE
          </Button>
        </div>
      </div>
